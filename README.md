# @dramaorg/reiciendis-eum-enim

![CI](https://github.com/dramaorg/reiciendis-eum-enim/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@dramaorg/reiciendis-eum-enim.svg?style=flat)](https://www.npmjs.com/package/@dramaorg/reiciendis-eum-enim)
...
```
npm i @dramaorg/reiciendis-eum-enim
```
...
const {
  createWarning,
  createDeprecation
} = require('@dramaorg/reiciendis-eum-enim')
...
```js
const { createWarning } = require('@dramaorg/reiciendis-eum-enim')
